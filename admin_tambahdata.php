        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container mt-3">
                    <h5>Tambah Data</h5>
                    <form class="container mb-5" name="form" action="create.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="tempatlahir">Level</label>
                            <input type="text" id="level" class="form-control" name="level" placeholder="Masukkan Level">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="gender" name="gender">Jenis Kelamin</label>
                            <input type="text" id="gender" class="form-control" name="gender" placeholder="Masukkan Jenis Kelamin">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="prodi" name="prodi" class="form-control" placeholder="Masukkan Prodi">
                        </div>
                        <div class="form-group">
                            <label for="tahunmasuk">Tahun Masuk</label>
                            <input type="text" id="tahunmasuk" name="tahunmasuk" class="form-control" placeholder="Masukkan Tahun Masuk">
                        </div>
                        <div class="form-group">
                            <label for="tahunkeluar">Tahun Lulus</label>
                            <input type="text" id="tahunkeluar" name="tahunkeluar" class="form-control" placeholder="Masukkan Tahun Lulus">
                        </div>
                        <div class="form-group">
