        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container mt-5">
                    <div class="container">
                    <a href="admin_dataalumni.php" class="btn btn-primary mb-3">Kembali</a>
                    </div>
                    <h5 class="container">Edit Data</h5>
                    <div class="container">
                        <div class="card mb-5">
                            <div class="card-header">
                                ...
                                while ($iya = mysqli_fetch_assoc($user)) { ?>
                                    <form method="post" action="update.php" enctype="multipart/form_data">
                                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="gender" id="gender">
                                <option value=""><?php echo $iya['gender'] ?></option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="agama" id="agama" >
                                <option value=""><?php echo $iya['agama'] ?></option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <img src="assets/img/foto_alumni/<?php echo $iya['foto']; ?>" style="width : 120px;float: left;margin-bottom: 5px" >
